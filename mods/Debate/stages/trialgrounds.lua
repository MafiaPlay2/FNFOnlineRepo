...
function onCreate()
    ...
    -- BG Characters
        ...
        makeAnimatedLuaSprite('himiko', directory .. 'bgcharacters/himiko', -550, -75);
        addAnimationByPrefix('himiko', 'idle', 'bgcharacters/himiko', charFramerate, true);
        addLuaSprite('himiko', false);

        makeAnimatedLuaSprite('tenko', directory .. 'bgcharacters/tenko', 500, -350);
        addAnimationByPrefix('tenko', 'idle', 'bgcharacters/tenko', charFramerate, true);
        addLuaSprite('tenko', false);

        makeAnimatedLuaSprite('kiibo', directory .. 'bgcharacters/kiibo', 1300, -300);
        addAnimationByPrefix('kiibo', 'idle', 'bgcharacters/kiibo', charFramerate, true);
        addLuaSprite('kiibo', false);

        makeAnimatedLuaSprite('kaito', directory .. 'bgcharacters/kaito', -450, 0);
        addAnimationByPrefix('kaito', 'idle', 'bgcharacters/kaito', charFramerate, true);
